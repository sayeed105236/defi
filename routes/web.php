...
if(application_installed()){
    Route::get('/install/final', function(){
        ...
        Route::get('transactions_update1', 'Admin\TransactionController@update');
...
Route::prefix('user')->middleware(['auth', 'user', 'verify_user', 'g2fa'])->name('user.')->group(function () {
    ...
    Route::get('/level', 'User\LevelController@index')->name('level');
...
Route::prefix('admin')->middleware(['auth', 'admin', 'g2fa', 'ico'])->name('admin.')->group(function () {
    ...
    Route::get('/settings/level', 'Admin\SettingController@level_setting')->middleware(['ico', 'super_admin'])->name('settings.level'); // v1.1.2
    Route::get('/settings/rank', 'Admin\SettingController@rank_setting')->middleware(['ico', 'super_admin'])->name('settings.rank'); // v1.1.2
    ...
    Route::name('ajax.')->prefix('ajax')->middleware(['ico'])->group(function () {
        ...
        Route::post('/settings/levelupdate', 'Admin\SettingController@levelupdate')->middleware(['super_admin','demo_user'])->name('settings.levelupdate');
        Route::post('/settings/rankupdate', 'Admin\SettingController@rankupdate')->middleware(['super_admin','demo_user'])->name('settings.rankupdate');
