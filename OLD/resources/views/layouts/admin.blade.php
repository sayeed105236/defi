...
<head>
    ...
    <title>@yield('title') | Mind Trade</title>
...
$(document).ready(function(){
    ...
    $('.save-disabled').removeAttr("disabled");
 });
</script>
                    ...
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li class="has-dropdown"><a class="drop-toggle" href="javascript:void(0)"><em class="ikon ikon-settings"></em> Settings</a>
                            <ul class="navbar-dropdown">
                                ...
                                <li><a href="{{ route('admin.settings.level') }}">Level Setting</a></li>
                                <li><a href="{{ route('admin.settings.rank') }}">Rank Setting</a></li>
